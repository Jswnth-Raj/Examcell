        ...
        <div class="col s12">
          <ul class="tabs  red darken-4">
           ...
           <li class="tab col s3"><a href="index.html" class="waves-effect waves-light white-text">HOME</a></li>
              <li class="tab col s3"><a href="academic_calendars.php" class="waves-effect waves-light white-text"><b>ACADEMIC CALENDARS</b></a></li>
...
<div class="row">
  ...
  <?php
    ...
    if (!$conn) {
        ...
        $sql="SELECT * FROM `academic_calendars` order by id desc";
...
<br><br><br><br><br>
    <footer class="page-footer red darken-4">
      ...
      <div class="row">
        ...
        <div class="col s1"><br>
        <button class="btn waves-effect waves-light grey lighten-5 pulse red-text" type="submit" name="submit"><b>Send</b>
        </button>
        </div>
        </form>
      </div>
