...
<head>
  ...
  <title>Giits Notifications</title>
        ...
        <div class="col s12">
          <ul class="tabs  cyan darken-4">
           ...
           <li class="tab col s3"><a href="index.html" class="waves-effect waves-light white-text">HOME</a></li>
              ...
              <li class="tab col s3"><a href="question_papers.php" class="waves-effect waves-light white-text">QUESTION PAPERS</a></li>
            ...
            <li class="tab col s3"><a href="mid_marks.php" class="waves-effect waves-light white-text">MID MARKS</b></a></li>
        <li class="tab col s3"><a href="lab_marks.php" class="waves-effect waves-light white-text">LAB MARKS</a></li>
        <li class="tab col s3"><a href="giits_notifications.php" class="waves-effect waves-light white-text"><b>GIITS NOTIFICATIONS</b></a></li>    
          </ul>
        </div>
      </div>
  </nav>
...
<div class="row">
  ...
  <?php
    ...
    if (!$conn) {
        ...
        $sql="SELECT * FROM `giits_notifications` order by id desc";
...
<br><br><br><br>
    <footer class="page-footer  cyan darken-4">
      ...
      <div class="row">
        ...
        <div class="col s1"><br>
        <button class="btn waves-effect waves-light grey lighten-5 pulse cyan-text" type="submit" name="submit"><b>Send</b>
        </button>
        </div>
        </form>
      </div>
