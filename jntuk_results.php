  ...
  <nav>
    <div class="nav-wrapper  deep-orange darken-3">
      ...
      <ul class="right">
        ...
        <div class="col s12">
          <ul class="tabs  deep-orange darken-3">
           ...
           <li class="tab col s3"><a href="index.html" class="waves-effect waves-light white-text">HOME</a></li>
            ...
            <li class="tab col s3"><a href="jntuk_results.php" class="waves-effect waves-light white-text"><b>JNTUK RESULTS</b></a></li>
...
<div class="row">
  ...
  <?php
    ...
    if (!$conn) {
        ...
        $sql="SELECT * FROM `jntuk_results` order by id desc";
...
<br><br><br><br>
    <footer class="page-footer  deep-orange darken-3">
      ...
      <div class="row">
        ...
        <div class="col s1"><br>
        <button class="btn waves-effect waves-light grey lighten-5 pulse orange-text" type="submit" name="submit"><b>Send</b>
        </button>
        </div>
        </form>
      </div>
