  ...
  <nav>
    <div class="nav-wrapper  teal darken-4">
      ...
      <ul class="right">
        ...
        <li class="tab col s3"><a href="lab_marks.php" class="waves-effect waves-light white-text"><b>LAB MARKS</b></a></li>
...
<div class="row">
  ...
  <?php
    ...
    if (!$conn) {
        ...
        $sql="SELECT * FROM `lab_marks` order by id desc";
...
<br><br><br><br>
    <footer class="page-footer  teal darken-4">
      ...
      <div class="row">
        ...
        <div class="col s1"><br>
        <button class="btn waves-effect waves-light grey lighten-5 pulse teal-text" type="submit" name="submit"><b>Send</b>
        </button>
        </div>
        </form>
      </div>
