          ...
          <ul class="tabs  purple darken-3">
           ...
           <li class="tab col s3"><a href="index.html" class="waves-effect waves-light white-text">HOME</a></li>
            ...
            <li class="tab col s3"><a href="jntuk_results.php" class="waves-effect waves-light white-text">JNTUK RESULTS</a></li>
              <li class="tab col s3"><a href="online_marks.php" class="waves-effect waves-light white-text"><b>ONLINE MARKS</b></a></li>
...
<div class="row">
  ...
  <?php
    ...
    if (!$conn) {
        ...
        $sql="SELECT * FROM `online_marks` order by id desc";
...
<br><br><br><br>
    <footer class="page-footer  purple darken-3">
      ...
      <div class="row">
        ...
        <div class="col s1"><br>
        <button class="btn waves-effect waves-light grey lighten-5 pulse purple-text" type="submit" name="submit"><b>Send</b>
        </button>
        </div>
        </form>
      </div>
